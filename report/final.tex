...
\caption{The first 10 lines of raw output of the master process with a 2-node slave cluster. The complete log is too long to list here.}
...
\subsection{\textbf{Requirement:} \emph{allow the user to set a time limit on the computation}}
...
\subsection{\textbf{Objective:} \emph{evaluate more game tree nodes than the non-distributed implementation}}
