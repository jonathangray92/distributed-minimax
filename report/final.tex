...
% Executive Summary
%
\section{Executive Summary\\\large{(Author: Steven Blenkinsop)}}
...
%
\pagebreak
\section{Acknowledgements\\\large{(Author: Steven Blenkinsop)}}

Our team would like to acknowledge the help of several people who contributed to the success of our project. First, we would like to thank our supervisor, Professor Jorg Liebeherr, for helping guide the project through its course and giving us the encouragement to make it happen. We'd also like to thank our administrator, Mr. John Taglione, for his invaluable feedback and guidance, and for giving us insight into how our experience with this project relates to real world engineering projects. Finally, we'd like to thank the Engineering Communication Program for all they've done to give us the opportunity to get the most out of this experience.
...
%
\section{Background and Motivation\\\large{(Author: Jonathan Gray)}}
...
% Project Goal
%
\section{Project Goal\\\large{(Author: Jonathan Gray)}}
...
%
\section{Project Requirements\\\large{(Author: Jonathan Gray)}}\label{sec:requirements}
...
\section{Final Design\\\large{(Author: Jonathan Gray)}}
...
%
\subsection{System-Level Overview\\\normalsize{(Author: Steven Blenkinsop)}}\label{sec:system}
...
%
\subsection{Module-Level Descriptions\\\normalsize{(Author: Jonathan Gray)}}\label{sec:modules}
...
%
\section{Testing and Verification\\\large{(Author: Jonathan Gray)}}
...
\subsection{\textbf{Requirement:} \emph{shall correctly implement the minimax algorithm}\\\small{(Author: Steven Blenkinsop)}}\label{sec:req-correctness}
...
% Conclusions
%
\section{Summary and Conclusions\\\large{(Author: Jonathan Gray)}}
...
%
\pagebreak
\section{Appendix A: Gantt Chart History\\\large{(Author: Jonathan Gray)}}
...
\includepdf[scale=0.8,pages={-},pagecommand=]{img/original-tests-2.pdf}
\includepdf[scale=0.8,pages={-},pagecommand=]{img/original-tests-3.pdf}
...
%
\pagebreak
\section{Appendix C: Code Samples\\\large{(Author: Jonathan Gray)}}
...
%
\pagebreak
\section{Appendix D: Screenshots\\\large{(Author: Jonathan Gray)}}
